// example.Siara — DeathByCaptcha Go client example.
// Solves a Siara CAPTCHA challenge (type 17) and prints the token.
package main
...
func main() {
	...
	// Put your Siara data here.
	captchaDict := map[string]string{
		"proxy":      "http://user:password@127.0.0.1:1234",
		"proxytype":  "HTTP",
		"slideurlid": "your_siara_slideurlid_here",
		"pageurl":    "https://your-siara-site.example.com/page",
	...
	params := map[string]string{
		"type":         "17",
		"siara_params": string(jsonCaptcha),
	}
