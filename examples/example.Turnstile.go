// example.Turnstile — DeathByCaptcha Go client example.
// Solves a Cloudflare Turnstile challenge (type 12) and prints the token.
package main
...
func main() {
	...
	params := map[string]string{
		"type":             "12",
		"turnstile_params": string(jsonCaptcha),
	}
