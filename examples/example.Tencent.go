// example.Tencent — DeathByCaptcha Go client example.
// Solves a Tencent CAPTCHA challenge (type 23) and prints the token.
package main
...
func main() {
	...
	// Put your Tencent data here.
	captchaDict := map[string]string{
		"proxy":     "http://user:password@127.0.0.1:1234",
		"proxytype": "HTTP",
		"appid":     "your_tencent_appid_here",
		"pageurl":   "https://your-tencent-site.example.com/page",
	}
	jsonCaptcha, _ := json.Marshal(captchaDict)

	params := map[string]string{
		"type":           "23",
		"tencent_params": string(jsonCaptcha),
	}
